...
public class Controller {
	...
	public static final String SHOPPING_LIST_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS "+SHOPPING_LIST_TABLE+" ("+LIST_ID+" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,"+LIST_NAME+" VARCHAR NOT NULL,"+ITEM_QUANTITY+" INTEGER NOT NULL,"+ITEM_BOUGHT+" INTEGER NOT NULL);";
	public static final String ITEMS_TABLE_CREATE_QUERY = "CREATE TABLE IF NOT EXISTS "+ITEMS_TABLE+" ("+ITEM_ID+" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,"+ITEM_NAME+" VARCHAR NOT NULL, " +
	...
	public void addItem(String name,int quantity) {
        ...
        shoppingListSQLHelper.getWritableDatabase().insert(ITEMS_TABLE, null, contentValues);
	}
...
//		Cursor tempCursor = shoppingListSQLHelper.getReadableDatabase().query(SHOPPING_LIST_TABLE, new String[]{LIST_ID,LIST_NAME}, 
...
//		Log.e(TAG_NAME, "ITEM LIST QUERY : "+ITEMS_TABLE_CREATE_QUERY);
	 ...
	 public boolean doesTblExist(String tblName){ 
	        Cursor rs = null; 
	        try{ 
	            rs = shoppingListSQLHelper.getReadableDatabase().rawQuery("SELECT * FROM " + SHOPPING_LIST_TABLE + " WHERE 1=0", null ); 
